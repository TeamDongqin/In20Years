...
- (instancetype)initWithImages:(NSArray *)images selectedIndices:(NSIndexSet *)selectedIndices borderColors:(NSArray *)colors {
    if (self = [super init]) {
        ...
        //            }
        //        }];
        [self doInit:images selectedIndices:selectedIndices borderColors:colors];
    }
    return self;
}
...
- (void) doInit:(NSArray *)images selectedIndices:(NSIndexSet *)selectedIndices borderColors:(NSArray *)colors{
    _isSingleSelect = NO;
    _contentView = [[UIScrollView alloc] init];
    _contentView.alwaysBounceHorizontal = NO;
    _contentView.alwaysBounceVertical = YES;
